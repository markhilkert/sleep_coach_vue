          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-12 page-next-level text-center">
                      <h4 class="pt-3">Privacy Policy</h4>
                  </div>                    
              </div>
          </div>
      </section>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="custom-faq mt-3">
                          ...
                          <p>
                            This privacy notice discloses the privacy practices for Sleep Coach. This privacy notice applies solely to information collected by this website. It will notify you of the following: <br> <br>
                          ...
                          <h6 class="mb-4"> &nbsp; Your Access to and Control Over Information  </h6>
                          <p>
                          ...
                          <p>
                            If you feel that we are not abiding by this privacy policy, you should contact us immediately at <a href="mailto: the.sleep.coach.app@gmail.com">the.sleep.coach.app@gmail.com</a>.
                          </p>
